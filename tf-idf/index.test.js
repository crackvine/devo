...
test('should return the correct term frequency for "unknown" within sample document one', () => {
  expect(termFrequency('unknown', testDocOne)).toBe(1);
});

test('should return the correct term frequency for "ipsum" within sample document one', () => {
  expect(termFrequency('ipsum', testDocOne)).toBe(3);
});
